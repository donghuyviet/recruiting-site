...
@section('content')
  <div class="row">
        ...
        <div class="col-md-10 wrapper" ng-controller="SearchCtrl" id="main-search" style="display:none">
            <div class="box">
                ...
                <div class="innerWordSearch">
                    ...
                    <div class="innerpopular">
                        <ul>
                            ...
                            <li ng-repeat="kword in featuredKeyword.favorite">
                                <a href="#" ng-click="doSearch(kword)">// kword //</a>
                            </li>
                        </ul>
                        <ul>
                            <li><a type="submit" class=" popularWord attentionWord ">人気ワード</a></li>
                            <li ng-repeat="kword in featuredKeyword.popular">
                                <a href="#" ng-click="doSearch(kword)">// kword //</a>
                            </li>
                        </ul>
                        <ul class="search-main">
                            <li><input class="input-search" type="text" id="valueSearch" ng-model="searchString" placeholder=" 例：データ入力、イベント"></li>
                            <li><a type="submit" class="img-submit" ng-click="doSearch()" ><img src="src/image/item/A_01_btn_search_01.png"></a></li>
                        </ul>
                    </div>
                </div>
            </div>
